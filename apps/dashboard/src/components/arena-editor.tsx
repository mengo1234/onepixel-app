...
import { countSeats, generateVenueDocument, parseVenueDocument, pointInLocalPolygon, polygonBounds, polygonCentroid, projectGeoBoundaryRings, rectangle, type ElementKind, type StoredLayout, type StoredVenue, type VenueDocument, type VenueElement } from "@/lib/venue-types";
...
function SeatOverridesPanel({ element, onChange, onActivateTool }: { element: VenueElement; onChange: (seats: NonNullable<VenueElement["seatOverrides"]>) => void; onActivateTool: () => void }) {
  ...
  return <Localized><div className="rounded-2xl border border-white/8 bg-[#0b0e0f] p-3">
...
export function ArenaEditor({ initialVenue, initialLayouts = [] }: { initialVenue?: StoredVenue; initialLayouts?: StoredLayout[] }) {
  ...
  return (
    <Localized><div className="overflow-hidden rounded-[34px] border border-white/10 bg-[#0e1213] shadow-[0_28px_90px_-40px_rgba(0,0,0,.85)]">
